COPY INTO "<<DB_NAME>>"."<<SCHEMA_NAME>>"."RAW_RESULTS_STAGING" (S3FILENAME,MSO,SERVICE_PROVIDER,HOUSEKEY,PROJECT_NAME,SCHEDULE_DATE,AGGREGATE_DATE,FILE_NAME,AVAILABILITY_STATUS,FIBER_MAXSPEED,UPLOADMAXSPEED,FIBER_TV_PROVIDER,FIBER_PHONE_PROVIDER,INTERNETCUSTOMER,INTERNETCUSTOMERSPEED,FIBER_TV_CUSTOMER,DIRECT_TV_CUSTOMER,WIRELESS_CUSTOMER,POTS_CUSTOMER,WIRECENTERCODE,S5G,LTE,S5G_SPEED,S4G_SPEED,S5G_UPLOAD_SPEED,RESULT_SOURCE,RESULT_FILENAME,RESULT_FILEDATE) FROM (SELECT metadata$filename,t.$1,t.$2,t.$3,t.$4,t.$5,t.$6,t.$7,t.$8,t.$9,t.$10,t.$11,t.$12,t.$13,t.$14,t.$15,t.$16,t.$17,t.$18,t.$19,t.$20,t.$21,t.$22,t.$23,t.$24,'<<source>>','<<file_name>>','<<current_date>>' FROM  '@"SCIERA_SUBSYSTEM"."REALWATCH"."SIS_SKYCTEL"/<<file_path>>' t) FILE_FORMAT = (COMPRESSION = 'AUTO' FIELD_DELIMITER = '|',RECORD_DELIMITER = '\n',SKIP_HEADER = 1,FIELD_OPTIONALLY_ENCLOSED_BY = '\"',TRIM_SPACE = TRUE, ERROR_ON_COLUMN_COUNT_MISMATCH = TRUE, ESCAPE = 'NONE', ESCAPE_UNENCLOSED_FIELD = '\134', DATE_FORMAT = 'AUTO', TIMESTAMP_FORMAT = 'AUTO', NULL_IF = ('NULL'),encoding = 'iso-8859-1') ON_ERROR = 'CONTINUE' PURGE = FALSE;
