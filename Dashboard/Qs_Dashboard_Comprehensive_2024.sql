...
/*Updated on : 2025-01-31 - We've added IFNULL(RESULT_SOURCE,'') <>'DP-PIPE' in QS_DASHBOARD_ROLLUPS_2024 To Remove System Generated ATT-AIR and VERIZON5G Results in The Dashboard*/
/*Updated on : 2025-03-05 - We've Added Zip9 and CB Flags For Fiber Growth Values*/


CREATE OR REPLACE TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024" AS
...
FROM V4_CTELL.PROC.WIP_CURRENT WHERE MSO='COMCAST' AND IFNULL(RESULT_SOURCE,'') <>'DP-PIPE' AND BUDGET_YEAR = 2024
...
INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024"
SELECT  IFF(BUDGET_YEAR IS NULL,QUEUE_YEAR,BUDGET_YEAR) AS BUDGET_YEAR, IFF(BUDGET_MONTH IS NULL,QUEUE_MONTH,BUDGET_MONTH) AS BUDGET_MONTH
,BUDGET_MONTH AS BUDGET_MONTH_ACTUAL,BUDGET_YEAR AS BUDGET_YEAR_ACTUAL,QUEUE_YEAR AS QUEUE_YEAR,QUEUE_MONTH AS QUEUE_MONTH,YEAR(CHECK_DATE) AS CHECKED_YEAR, MONTH(CHECK_DATE) AS CHECKED_MONTH, DELIVERED_YEAR,DELIVERED_MONTH,UPPER(MSO) AS MSO,UPPER(ENGAGEMENT_TYPE) AS ENGAGEMENT_TYPE,UPPER(BUDGET_TYPE) AS BUDGET_TYPE,UPPER(PROJECT_TYPE) AS PROJECT_TYPE,DWELL_TYPE,
UPPER(PROJECTNAME) AS PROJECT_NAME,UPPER(SERVICENAME) AS PUBLISHNAME,UPPER(STD_NAME) AS STD_NAME,
CASE WHEN SERVICENAME IN  ('ATT','BRIGHTSPEED','CENTURYLINK','FRONTIER111COMMUNICATIONS','WINDSTREAM','VERIZON') 
...
UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024"A
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024"
ADD COLUMN SERVICENAME VARCHAR(16777216) DEFAULT NULL;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024"  
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024" ADD COLUMN UPDATED_DATE VARCHAR(16777216);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024" SET UPDATED_DATE=CURRENT_DATE();

  
CREATE OR REPLACE TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ZIP_ROLLUPS_2024" AS
...
SUM(DELIVERED_STATUS_NF) DELIVERED_STATUS_NF,SUM(DELIVERED_GIG_RESULT) DELIVERED_GIG_RESULT FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024"
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ZIP_ROLLUPS_2024"
ADD COLUMN RECEIVED_COUNT VARCHAR(16777216) DEFAULT NULL;


UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ZIP_ROLLUPS_2024"A
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ZIP_ROLLUPS_2024" ADD COLUMN UPDATED_DATE VARCHAR(16777216);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ZIP_ROLLUPS_2024" SET UPDATED_DATE=CURRENT_DATE();

CREATE OR REPLACE TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_DMA_ZIP_ROLLUPS_2024" AS
...
MTD_DELIVERED_PROVIDER  FROM  "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_DMA_ZIP_ROLLUPS_2024"  ;

ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_DMA_ZIP_ROLLUPS_2024" ADD COLUMN UPDATED_DATE VARCHAR(16777216);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_DMA_ZIP_ROLLUPS_2024" SET UPDATED_DATE=CURRENT_DATE();

CREATE OR REPLACE TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024" AS
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024"
...
UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024" A
SET A.RECEIVED_COUNT = B.RECEIVED_COUNT,
    ...
    FROM
(SELECT BUDGET_YEAR,BUDGET_MONTH,MSO,PROJECT_NAME,PUBLISH_NAME,DIVISION,SUM(RECEIVED_COUNT) RECEIVED_COUNT,INPUT_FILE_NAME,INPUT_CLIENT_NAME,RECEIVED_DATE
 FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,PROJECT_NAME,PUBLISH_NAME,DIVISION,INPUT_FILE_NAME,INPUT_CLIENT_NAME,RECEIVED_DATE ) B WHERE 
UPPER(A.PROJECT_NAME)= UPPER(B.PROJECT_NAME)
AND UPPER(A.PUBLISHNAME )= UPPER( B.PUBLISH_NAME) AND A.BUDGET_YEAR = B.BUDGET_YEAR
AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.MSO = B.MSO AND A.H1 = B.DIVISION AND A.MSO = 'COMCAST'; 
...
UPPER(A.PROJECT_NAME)= UPPER(B.PROJECT_NAME)
AND UPPER(A.PUBLISHNAME )= UPPER( B.PUBLISH_NAME) AND A.BUDGET_YEAR = B.BUDGET_YEAR
AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.MSO = B.MSO AND A.MSO <> 'COMCAST';

UPDATE  "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024"
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024" ADD COLUMN UPDATED_DATE VARCHAR(16777216);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024" SET UPDATED_DATE=CURRENT_DATE();

CREATE OR REPLACE TABLE  "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" AS
...
INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" (BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,H1,SOW,PUBLISHNAME,TARGET)
...
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024"
GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,H1,SOW) A LEFT JOIN 
"SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" B ON  A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" 
...
UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" A
...
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024" GROUP BY ALL) B
...
GROUP BY ALL)B
WHERE A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH 
AND A.MSO = B.MSO  AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND UPPER(A.PUBLISHNAME) = UPPER(B.PUBLISH_NAME);
...
UPDATE  "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" 
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" ADD COLUMN UPDATED_DATE VARCHAR(16777216);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" SET UPDATED_DATE=CURRENT_DATE();

CREATE OR REPLACE TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS_2024" AS
...
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024"
GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,H1,SOW;

ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS_2024"
ADD COLUMN TARGET VARCHAR(16777216) DEFAULT NULL;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS_2024"   A
...
UPDATE  "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS_2024"
SET FIBER_COUNT_NQ = CASE WHEN  FIBER_COUNT_NQ  IS NULL THEN 0 ELSE FIBER_COUNT_NQ END,
FIBER_COUNT_WL = CASE WHEN  FIBER_COUNT_WL  IS NULL THEN 0 ELSE FIBER_COUNT_WL END,
FIBER_COUNT_BL = CASE WHEN  FIBER_COUNT_BL  IS NULL THEN 0 ELSE FIBER_COUNT_BL END,
FIBER_COUNT = CASE WHEN  FIBER_COUNT  IS NULL THEN 0 ELSE FIBER_COUNT END,
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS_2024" ADD COLUMN UPDATED_DATE VARCHAR(16777216);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS_2024" SET UPDATED_DATE=CURRENT_DATE();

CREATE OR REPLACE TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROVIDER_ROLLUPS_2024" AS
...
ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROVIDER_ROLLUPS_2024" 
ADD COLUMN TARGET VARCHAR(16777216) DEFAULT NULL;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROVIDER_ROLLUPS_2024" A
...
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024" B
WHERE A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
AND A.MSO = B.MSO AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND A.PUBLISHNAME =B.PUBLISHNAME ; 

ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROVIDER_ROLLUPS_2024" ADD COLUMN UPDATED_DATE VARCHAR(16777216);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROVIDER_ROLLUPS_2024" SET UPDATED_DATE=CURRENT_DATE();
