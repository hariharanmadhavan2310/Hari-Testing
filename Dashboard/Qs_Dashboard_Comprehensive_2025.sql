...
INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" (BUDGET_YEAR,BUDGET_MONTH,BUDGET_TYPE,MSO,ENGAGEMENT_TYPE,PROJECT_TYPE,INPUT_TYPE,TASK_ID,INPUT_FILE_NAME,INPUT_CLIENT_NAME,RECEIVED_DATE,RECEIVED_COUNT,PROJECT_NAME,PROVIDER_NAME,PUBLISH_NAME,DELIVERY_NAME,ZIP,DIVISION,REGION)
SELECT TRY_CAST(BUDGET_YEAR AS INT), TRY_CAST(BUDGET_MONTH AS INT),
CASE WHEN UPPER(PUBLISH_NAME)='ATT' THEN 'ATT'
                       WHEN UPPER(PUBLISH_NAME) IN ('TMOBILE5G-HOME','VERIZON1115G') THEN 'FWA'
                       ELSE 'NON ATT' END BUDGET_TYPE,MSO,ENGAGEMENT_TYPE,PROJECT_TYPE,INPUT_TYPE,TASK_ID,TASK_NAME,INPUT_CLIENT_NAME,TRY_CAST(DATE_CREATED AS DATE),TRY_CAST(SPLIT_PART(T1.VALUE,'=',2) AS INT),PROJECT_NAME,PROVIDER_NAME,PUBLISH_NAME,DELIVERY_NAME,TRIM(SPLIT_PART(T1.VALUE,'=',1)) AS ZIP,DIVISION,REGION FROM  "SCIERA_SUBSYSTEM"."CTELL_TRACKING"."COMCAST_BUDGET_PLAN_TEST_REGION", 
    LATERAL SPLIT_TO_TABLE(ZIP_EXP, ',') AS T1 WHERE INPUT_TYPE = 'ZIP5_LEVEL';
...
CASE WHEN UPPER(PUBLISH_NAME)='ATT' THEN 'ATT'
                       WHEN UPPER(PUBLISH_NAME) IN ('TMOBILE5G-HOME','VERIZON1115G') THEN 'FWA'
                       ELSE 'NON ATT' END BUDGET_TYPE,MSO,ENGAGEMENT_TYPE,PROJECT_TYPE,INPUT_TYPE,TASK_ID,TASK_NAME,INPUT_CLIENT_NAME,TRY_CAST(DATE_CREATED AS DATE),TARGET_VOLUME,PROJECT_NAME,PROVIDER_NAME,PUBLISH_NAME,DELIVERY_NAME,ZIP,DIVISION,REGION FROM  "SCIERA_SUBSYSTEM"."CTELL_TRACKING"."COMCAST_BUDGET_PLAN_TEST_REGION" WHERE INPUT_TYPE <> 'ZIP5_LEVEL';	
...
FROM (SELECT MSO,SERVICENAME,PROJECTNAME,ZIP5,MIN(SCHEDULEDATE) SCHEDULEDATE,COUNT(*) QUEUED, SUM(IFF(CHECK_DATE IS NOT NULL,1,0)) CHECKED, SUM(IFF(DELIVERED_YEAR IS NOT NULL,1,0)) DELIVERED,
 SUM(IFF(QUARANTINE_FLAG ='Y',1,0)) UNDELIVERABLE,SUM(IFF(CHECK_DATE IS NOT NULL AND MAX_SPEED>=300,1,0)) AS FIBER_COUNT FROM V4_CTELL.PROC.WIP_CURRENT GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,SERVICENAME,PROJECTNAME,ZIP5) B    
...
FROM (SELECT MSO,SERVICENAME,PROJECTNAME,MIN(SCHEDULEDATE) SCHEDULEDATE,COUNT(*) QUEUED, SUM(IFF(CHECK_DATE IS NOT NULL,1,0)) CHECKED, SUM(IFF(DELIVERED_YEAR IS NOT NULL,1,0)) DELIVERED,
 SUM(IFF(QUARANTINE_FLAG ='Y',1,0)) UNDELIVERABLE,SUM(IFF(CHECK_DATE IS NOT NULL AND MAX_SPEED>=300,1,0)) AS FIBER_COUNT FROM V4_CTELL.PROC.WIP_CURRENT GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,SERVICENAME,PROJECTNAME) B    
WHERE A.MSO = B.MSO AND UPPER(A.PUBLISH_NAME) = UPPER(B.SERVICENAME)
 AND  (UPPER(A.PROJECT_NAME) = UPPER(B.PROJECTNAME)
  OR UPPER(A.INPUT_FILE_NAME) LIKE '%' || UPPER(B.PROJECTNAME)||'%'
 OR  UPPER(B.PROJECTNAME) LIKE '%' || UPPER(A.INPUT_FILE_NAME)||'%' )
...
AND DIVISION IN ('NORTHEAST DIVISION','CENTRAL DIVISION') AND BUDGET_YEAR = 2024;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN"
SET SOW = 'NED'
WHERE (MSO= 'COMCAST_BUSINESS' OR MSO= 'COMCAST') AND DIVISION = 'NORTHEAST DIVISION' AND BUDGET_YEAR = 2025;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN"
SET SOW = 'CENTRAL'
WHERE (MSO= 'COMCAST_BUSINESS' OR MSO= 'COMCAST') AND DIVISION = 'CENTRAL DIVISION' AND BUDGET_YEAR = 2025;
...
AND H1 IN ('NORTHEAST DIVISION','CENTRAL DIVISION') AND BUDGET_YEAR = 2024;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS"
SET SOW = 'NED'
WHERE (MSO= 'COMCAST_BUSINESS' OR MSO= 'COMCAST') AND H1 = 'NORTHEAST DIVISION' AND BUDGET_YEAR = 2025;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS"
SET SOW = 'CENTRAL'
WHERE (MSO= 'COMCAST_BUSINESS' OR MSO= 'COMCAST') AND H1 = 'CENTRAL DIVISION' AND BUDGET_YEAR = 2025;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS"
SET SOW = 'WEST' 
WHERE (MSO= 'COMCAST_BUSINESS' OR MSO= 'COMCAST') AND H1 = 'WEST DIVISION';
...
SELECT BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,PROJECT_TYPE,PROJECT_NAME,PUBLISHNAME,SERVICENAME,H1,CASE WHEN MSO = 'COMCAST' AND H1 = 'NORTHEAST DIVISION' AND SUBSTR(PROJECT_NAME,1,1) <> 'A' THEN REGION ELSE NULL END AS REGION_NEW,SOW,DELIVERY_NAME,
...
SUM(CHECKED_GIG_RESULT) CHECKED_GIG_RESULT,SUM(DELIVERED_STATUS_AV) DELIVERED_STATUS_AV,SUM(DELIVERED_STATUS_NA) DELIVERED_STATUS_NA,
SUM(DELIVERED_STATUS_ER) DELIVERED_STATUS_ER,
SUM(DELIVERED_STATUS_NF) DELIVERED_STATUS_NF,SUM(DELIVERED_GIG_RESULT) DELIVERED_GIG_RESULT,SUM(ZIP9_ALL_CHECKS) ZIP9_ALL_CHECKS,SUM(ZIP9_ALL_FIBER) ZIP9_ALL_FIBER,SUM(ZIP9_12M_CHECKS) ZIP9_12M_CHECKS,SUM(ZIP9_12M_FIBER) ZIP9_12M_FIBER,SUM(ZIP9_6M_CHECKS) ZIP9_6M_CHECKS,SUM(ZIP9_6M_FIBER) ZIP9_6M_FIBER,SUM(ZIP9_3M_CHECKS) ZIP9_3M_CHECKS,SUM(ZIP9_3M_FIBER) ZIP9_3M_FIBER,SUM(ZIP9_NEWAREA_CHECKS) ZIP9_NEWAREA_CHECKS,SUM(ZIP9_NEWAREA_FIBER) ZIP9_NEWAREA_FIBER,SUM(CB_ALL_CHECKS) CB_ALL_CHECKS,SUM(CB_ALL_FIBER) CB_ALL_FIBER,SUM(CB_12M_CHECKS) CB_12M_CHECKS,SUM(CB_12M_FIBER) CB_12M_FIBER,SUM(CB_6M_CHECKS) CB_6M_CHECKS,SUM(CB_6M_FIBER) CB_6M_FIBER,SUM(CB_3M_CHECKS) CB_3M_CHECKS,SUM(CB_3M_FIBER) CB_3M_FIBER,SUM(CB_NEWAREA_CHECKS) CB_NEWAREA_CHECKS,SUM(CB_NEWAREA_FIBER) CB_NEWAREA_FIBER,
SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=1 AND DELIVERED_YEAR,DELIVERED,0)) AS JAN_2025,SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=2,DELIVERED,0)) AS FEB_2025,
SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=3,DELIVERED,0)) AS MARCH_2025,SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=4,DELIVERED,0)) AS APRIL_2025,
SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=5,DELIVERED,0)) AS MAY_2025,SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=6,DELIVERED,0)) AS JUNE_2025,
SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=7,DELIVERED,0)) AS JULY_2025,SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=8,DELIVERED,0)) AS AUG_2025,
SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=9,DELIVERED,0)) AS SEP_2025,SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=10,DELIVERED,0)) AS OCT_2025,
SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=11,DELIVERED,0)) AS NOV_2025,SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=12,DELIVERED,0)) AS DEC_2025
 FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS"
GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,PROJECT_TYPE,PROJECT_NAME,PUBLISHNAME,SERVICENAME,H1,REGION_NEW,SOW,DELIVERY_NAME;
...
SET A.RECEIVED_COUNT = B.RECEIVED_COUNT,
    ...
    FROM (SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, PROJECT_NAME, PUBLISH_NAME, DIVISION, REGION, SUM(RECEIVED_COUNT) RECEIVED_COUNT, INPUT_FILE_NAME, INPUT_CLIENT_NAME, RECEIVED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" GROUP BY BUDGET_YEAR, BUDGET_MONTH, MSO, PROJECT_NAME, PUBLISH_NAME, DIVISION, REGION, INPUT_FILE_NAME, INPUT_CLIENT_NAME, RECEIVED_DATE) B 
WHERE UPPER(A.PROJECT_NAME)= UPPER(B.PROJECT_NAME) AND UPPER(A.PUBLISHNAME )= UPPER( B.PUBLISH_NAME) AND A.BUDGET_YEAR = B.BUDGET_YEAR
AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.MSO = B.MSO AND IFNULL(A.H1,'') = IFNULL(B.DIVISION,'') AND IFNULL(A.REGION,'') = IFNULL(B.REGION,'') AND A.MSO = 'COMCAST' AND H1 = 'NORTHEAST DIVISION' AND SUBSTR(B.PROJECT_NAME,1,1) <> 'A';
...
SET A.RECEIVED_COUNT = B.RECEIVED_COUNT,
    ...
    A.CLIENT_PROVIDER_NAME = B.INPUT_CLIENT_NAME,
    A.CLIENT_SENT_DATE = B.RECEIVED_DATE
    FROM (SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, PROJECT_NAME, PUBLISH_NAME, DIVISION, SUM(RECEIVED_COUNT) RECEIVED_COUNT, INPUT_FILE_NAME, INPUT_CLIENT_NAME, RECEIVED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" GROUP BY BUDGET_YEAR, BUDGET_MONTH, MSO, PROJECT_NAME, PUBLISH_NAME, DIVISION, INPUT_FILE_NAME, INPUT_CLIENT_NAME, RECEIVED_DATE) B 
WHERE UPPER(A.PROJECT_NAME)= UPPER(B.PROJECT_NAME) AND UPPER(A.PUBLISHNAME )= UPPER( B.PUBLISH_NAME) AND A.BUDGET_YEAR = B.BUDGET_YEAR
AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.MSO = B.MSO AND IFNULL(A.H1,'') = IFNULL(B.DIVISION,'') AND ((B.MSO = 'COMCAST' AND B.DIVISION <> 'NORTHEAST DIVISION') OR (A.MSO = 'COMCAST' AND DIVISION = 'NORTHEAST DIVISION' AND SUBSTR(B.PROJECT_NAME,1,1) = 'A'));
...
SET A.RECEIVED_COUNT = B.RECEIVED_COUNT,
    ...
    A.CLIENT_PROVIDER_NAME = B.INPUT_CLIENT_NAME,
    A.CLIENT_SENT_DATE = B.RECEIVED_DATE
    FROM (SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, PROJECT_NAME, PUBLISH_NAME, SUM(RECEIVED_COUNT) RECEIVED_COUNT, INPUT_FILE_NAME, INPUT_CLIENT_NAME, RECEIVED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" GROUP BY BUDGET_YEAR, BUDGET_MONTH, MSO, PROJECT_NAME, PUBLISH_NAME, INPUT_FILE_NAME, INPUT_CLIENT_NAME, RECEIVED_DATE) B 
WHERE UPPER(A.PROJECT_NAME)= UPPER(B.PROJECT_NAME) AND UPPER(A.PUBLISHNAME )= UPPER( B.PUBLISH_NAME) AND A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.MSO = B.MSO AND A.MSO <> 'COMCAST';
...
ZIP9_ALL_CHECKS =  CASE WHEN ZIP9_ALL_CHECKS  IS NULL THEN 0 ELSE ZIP9_ALL_CHECKS END,
ZIP9_ALL_FIBER = CASE WHEN ZIP9_ALL_FIBER   IS NULL THEN 0 ELSE ZIP9_ALL_FIBER END, 
ZIP9_12M_CHECKS = CASE WHEN ZIP9_12M_CHECKS  IS NULL THEN 0 ELSE ZIP9_12M_CHECKS END,
ZIP9_12M_FIBER = CASE WHEN ZIP9_12M_FIBER   IS NULL THEN 0 ELSE ZIP9_12M_FIBER END,
ZIP9_6M_CHECKS = CASE WHEN ZIP9_6M_CHECKS   IS NULL THEN 0 ELSE ZIP9_6M_CHECKS END,
ZIP9_6M_FIBER = CASE WHEN ZIP9_6M_FIBER   IS NULL THEN 0 ELSE ZIP9_6M_FIBER END, 
ZIP9_3M_CHECKS = CASE WHEN ZIP9_3M_CHECKS   IS NULL THEN 0 ELSE ZIP9_3M_CHECKS END, 
ZIP9_3M_FIBER = CASE WHEN ZIP9_3M_FIBER   IS NULL THEN 0 ELSE ZIP9_3M_FIBER END,
ZIP9_NEWAREA_CHECKS = CASE WHEN ZIP9_NEWAREA_CHECKS  IS NULL THEN 0 ELSE ZIP9_NEWAREA_CHECKS END, 
ZIP9_NEWAREA_FIBER = CASE WHEN ZIP9_NEWAREA_FIBER  IS NULL THEN 0 ELSE ZIP9_NEWAREA_FIBER END,  
CB_ALL_CHECKS = CASE WHEN CB_ALL_CHECKS  IS NULL THEN 0 ELSE CB_ALL_CHECKS END,
CB_ALL_FIBER = CASE WHEN CB_ALL_FIBER   IS NULL THEN 0 ELSE CB_ALL_FIBER END, 
CB_12M_CHECKS = CASE WHEN CB_12M_CHECKS  IS NULL THEN 0 ELSE CB_12M_CHECKS END,
CB_12M_FIBER = CASE WHEN CB_12M_FIBER   IS NULL THEN 0 ELSE CB_12M_FIBER END, 
CB_6M_CHECKS = CASE WHEN CB_6M_CHECKS   IS NULL THEN 0 ELSE CB_6M_CHECKS END, 
CB_6M_FIBER = CASE WHEN CB_6M_FIBER   IS NULL THEN 0 ELSE CB_6M_FIBER END, 
CB_3M_CHECKS = CASE WHEN CB_3M_CHECKS  IS NULL THEN 0 ELSE  CB_3M_CHECKS END, 
CB_3M_FIBER = CASE WHEN CB_3M_FIBER   IS NULL THEN 0 ELSE CB_3M_FIBER END, 
CB_NEWAREA_CHECKS = CASE WHEN CB_NEWAREA_CHECKS  IS NULL THEN 0 ELSE CB_NEWAREA_CHECKS END, 
CB_NEWAREA_FIBER = CASE WHEN CB_NEWAREA_FIBER  IS NULL THEN 0 ELSE CB_NEWAREA_FIBER END,
JAN_2025 = CASE WHEN JAN_2025  IS NULL THEN 0 ELSE JAN_2025 END,
FEB_2025 = CASE WHEN FEB_2025  IS NULL THEN 0 ELSE FEB_2025 END,
MARCH_2025 = CASE WHEN MARCH_2025  IS NULL THEN 0 ELSE MARCH_2025 END,
APRIL_2025 = CASE WHEN APRIL_2025  IS NULL THEN 0 ELSE APRIL_2025 END,
MAY_2025 = CASE WHEN MAY_2025  IS NULL THEN 0 ELSE MAY_2025 END,
JUNE_2025 = CASE WHEN JUNE_2025  IS NULL THEN 0 ELSE JUNE_2025 END,
JULY_2025 = CASE WHEN JULY_2025  IS NULL THEN 0 ELSE JULY_2025 END,
AUG_2025 = CASE WHEN AUG_2025  IS NULL THEN 0 ELSE AUG_2025 END,
SEP_2025 = CASE WHEN SEP_2025  IS NULL THEN 0 ELSE SEP_2025 END,
OCT_2025 = CASE WHEN OCT_2025  IS NULL THEN 0 ELSE OCT_2025 END,
NOV_2025 = CASE WHEN NOV_2025  IS NULL THEN 0 ELSE NOV_2025 END,
DEC_2025 = CASE WHEN DEC_2025  IS NULL THEN 0 ELSE DEC_2025 END,
...
SELECT BUDGET_YEAR, BUDGET_MONTH,IFF(ENGAGEMENT_TYPE = 'RESI',MSO,MSO||'_BUSINESS') AS MSO,ENGAGEMENT_TYPE,IFNULL(DIVISION,'') AS H1,REGION,SOW,PUBLISH_NAME AS PUBLISHNAME, CAST(MONTHLY_TARGET AS INT) OPS_TARGET, CAST(MONTHLY_SOW_TARGET AS INT) SOW_TARGET FROM "SCIERA_SUBSYSTEM"."CTELL_TRACKING"."MSO_TRACKING" WHERE BUDGET_YEAR = 2025;

INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" (BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,H1,REGION,SOW,PUBLISHNAME,OPS_TARGET,SOW_TARGET)
SELECT A.BUDGET_YEAR,A.BUDGET_MONTH,A.MSO,A.ENGAGEMENT_TYPE,A.H1,A.REGION,A.SOW,A.PUBLISHNAME,0 AS OPS_TARGET, 0 AS SOW_TARGET FROM (SELECT BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,IFNULL(H1,'') AS H1,REGION,SOW
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS" WHERE MSO = 'COMCAST' AND H1 = 'NORTHEAST DIVISION'
GROUP BY ALL) A LEFT JOIN (SELECT * FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" WHERE MSO = 'COMCAST' AND H1 = 'NORTHEAST DIVISION') B ON  A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
AND A.MSO = B.MSO AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') =  IFNULL(B.SOW,'') AND A.PUBLISHNAME =B.PUBLISHNAME AND A.H1 = B.H1 AND IFNULL(A.REGION,'') = IFNULL(B.REGION,'')
WHERE B.PUBLISHNAME IS NULL AND A.BUDGET_YEAR = 2025;

INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" (BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,H1,SOW,PUBLISHNAME,OPS_TARGET,SOW_TARGET)
SELECT A.BUDGET_YEAR,A.BUDGET_MONTH,A.MSO,A.ENGAGEMENT_TYPE,A.H1,A.SOW,A.PUBLISHNAME,0 AS OPS_TARGET, 0 AS SOW_TARGET FROM (SELECT BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,SOW,IFNULL(H1,'') H1
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS" WHERE MSO = 'COMCAST' AND H1 <> 'NORTHEAST DIVISION'
GROUP BY ALL) A LEFT JOIN (SELECT * FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" WHERE MSO = 'COMCAST' AND H1 <> 'NORTHEAST DIVISION') B ON  A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
AND A.MSO = B.MSO AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') =  IFNULL(B.SOW,'') AND A.PUBLISHNAME =B.PUBLISHNAME AND A.H1 = B.H1
WHERE B.PUBLISHNAME IS NULL AND A.BUDGET_YEAR = 2025; 

INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" (BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,H1,REGION,SOW,PUBLISHNAME,OPS_TARGET,SOW_TARGET)
SELECT A.BUDGET_YEAR,A.BUDGET_MONTH,A.MSO,A.ENGAGEMENT_TYPE,A.H1,A.REGION,A.SOW,A.PUBLISHNAME,0 AS OPS_TARGET, 0 AS SOW_TARGET FROM (SELECT BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,SOW,IFNULL(H1,'') H1,REGION
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS" WHERE MSO <> 'COMCAST'
GROUP BY ALL) A LEFT JOIN (SELECT * FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" WHERE MSO <> 'COMCAST') B ON  A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
...
FIBER_DELIVERED_NQ  NUMBER(38,0) DEFAULT NULL,
FIBER_DELIVERED_WL  NUMBER(38,0) DEFAULT NULL,
FIBER_DELIVERED_BL  NUMBER(38,0) DEFAULT NULL,
FIBER_DELIVERED  NUMBER(38,0) DEFAULT NULL,
RECEIVED_COUNT_NQ  NUMBER(38,0) DEFAULT NULL,
RECEIVED_COUNT_WL  NUMBER(38,0) DEFAULT NULL,
OPS_RECEIVED_COUNT_BL   NUMBER(38,0) DEFAULT NULL,
SOW_RECEIVED_COUNT_BL   NUMBER(38,0) DEFAULT NULL,
RECEIVED_COUNT  NUMBER(38,0) DEFAULT NULL,
ZIP9_ALL_CHECKS NUMBER(38,0) DEFAULT NULL, 
ZIP9_ALL_FIBER NUMBER(38,0) DEFAULT NULL,
ZIP9_12M_CHECKS NUMBER(38,0) DEFAULT NULL,
ZIP9_12M_FIBER NUMBER(38,0) DEFAULT NULL,
ZIP9_6M_CHECKS NUMBER(38,0) DEFAULT NULL,
ZIP9_6M_FIBER NUMBER(38,0) DEFAULT NULL,
ZIP9_3M_CHECKS NUMBER(38,0) DEFAULT NULL,
ZIP9_3M_FIBER NUMBER(38,0) DEFAULT NULL,
ZIP9_NEWAREA_CHECKS NUMBER(38,0) DEFAULT NULL,
ZIP9_NEWAREA_FIBER NUMBER(38,0) DEFAULT NULL,
CB_ALL_CHECKS NUMBER(38,0) DEFAULT NULL,
CB_ALL_FIBER NUMBER(38,0) DEFAULT NULL,
CB_12M_CHECKS NUMBER(38,0) DEFAULT NULL,
CB_12M_FIBER NUMBER(38,0) DEFAULT NULL,
CB_6M_CHECKS NUMBER(38,0) DEFAULT NULL,
CB_6M_FIBER NUMBER(38,0) DEFAULT NULL,
CB_3M_CHECKS NUMBER(38,0) DEFAULT NULL,
CB_3M_FIBER NUMBER(38,0) DEFAULT NULL,
CB_NEWAREA_CHECKS NUMBER(38,0) DEFAULT NULL,
CB_NEWAREA_FIBER NUMBER(38,0) DEFAULT NULL;
...
A.DELIVERED  = B.DELIVERED,
A.FIBER_DELIVERED_NQ  = B.FIBER_DELIVERED_NQ,
A.FIBER_DELIVERED_WL  = B.FIBER_DELIVERED_WL,
A.FIBER_DELIVERED_BL  = B.FIBER_DELIVERED_BL,
A.FIBER_DELIVERED  = B.FIBER_DELIVERED,
A.ZIP9_ALL_CHECKS = B.ZIP9_ALL_CHECKS,
A.ZIP9_ALL_FIBER = B.ZIP9_ALL_FIBER,
A.ZIP9_12M_CHECKS = B.ZIP9_12M_CHECKS,
A.ZIP9_12M_FIBER = B.ZIP9_12M_FIBER,
A.ZIP9_6M_CHECKS = B.ZIP9_6M_CHECKS,
A.ZIP9_6M_FIBER = B.ZIP9_6M_FIBER,
A.ZIP9_3M_CHECKS = B.ZIP9_3M_CHECKS, 
A.ZIP9_3M_FIBER = B. ZIP9_3M_FIBER,
A.ZIP9_NEWAREA_CHECKS = B.ZIP9_NEWAREA_CHECKS,
A.ZIP9_NEWAREA_FIBER =  B.ZIP9_NEWAREA_FIBER,
A.CB_ALL_CHECKS = B.CB_ALL_CHECKS,
A.CB_ALL_FIBER = B.CB_ALL_FIBER,
A.CB_12M_CHECKS = B.CB_12M_CHECKS,
A.CB_12M_FIBER = B.CB_12M_FIBER,
A.CB_6M_CHECKS = B.CB_6M_CHECKS,
A.CB_6M_FIBER = B.CB_6M_FIBER,
A.CB_3M_CHECKS = B.CB_3M_CHECKS,
A.CB_3M_FIBER = B.CB_3M_FIBER,
A.CB_NEWAREA_CHECKS = B.CB_NEWAREA_CHECKS,
A.CB_NEWAREA_FIBER = B.CB_NEWAREA_FIBER
FROM
(SELECT BUDGET_YEAR,BUDGET_MONTH,H1,REGION,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,SOW,
...
CAST(SUM(IFF(PROJECT_TYPE= 'NQ',FIBER_DELIVERED_COUNT,0)) AS INT) FIBER_DELIVERED_NQ, 
CAST(SUM(IFF(PROJECT_TYPE= 'WL',FIBER_DELIVERED_COUNT,0)) AS INT) FIBER_DELIVERED_WL,
CAST(SUM(IFF(PROJECT_TYPE= 'BL',FIBER_DELIVERED_COUNT,0)) AS INT) FIBER_DELIVERED_BL, 
CAST(SUM(FIBER_DELIVERED_COUNT) AS INT) FIBER_DELIVERED,
...
CAST(SUM(IFF(PROJECT_TYPE= 'BL',RECEIVED_COUNT,0)) AS INT) OPS_RECEIVED_COUNT_BL,
CAST(SUM(IFF(PROJECT_TYPE= 'BL',RECEIVED_COUNT,0)) AS INT) SOW_RECEIVED_COUNT_BL,
CAST(SUM(RECEIVED_COUNT) AS INT) RECEIVED_COUNT,
CAST(SUM(ZIP9_ALL_CHECKS) AS INT) ZIP9_ALL_CHECKS,
CAST(SUM(ZIP9_ALL_FIBER) AS INT) ZIP9_ALL_FIBER,
CAST(SUM(ZIP9_12M_CHECKS) AS INT) ZIP9_12M_CHECKS,
CAST(SUM(ZIP9_12M_FIBER) AS INT) ZIP9_12M_FIBER,
CAST(SUM(ZIP9_6M_CHECKS) AS INT) ZIP9_6M_CHECKS,
CAST(SUM(ZIP9_6M_FIBER) AS INT) ZIP9_6M_FIBER,
CAST(SUM(ZIP9_3M_CHECKS) AS INT) ZIP9_3M_CHECKS, 
CAST(SUM(ZIP9_3M_FIBER) AS INT)  ZIP9_3M_FIBER,
CAST(SUM(ZIP9_NEWAREA_CHECKS) AS INT) ZIP9_NEWAREA_CHECKS,
CAST(SUM(ZIP9_NEWAREA_FIBER) AS INT) ZIP9_NEWAREA_FIBER,
CAST(SUM(CB_ALL_CHECKS) AS INT) CB_ALL_CHECKS,
CAST(SUM(CB_ALL_FIBER) AS INT) CB_ALL_FIBER,
CAST(SUM(CB_12M_CHECKS) AS INT) CB_12M_CHECKS,
CAST(SUM(CB_12M_FIBER) AS INT) CB_12M_FIBER,
CAST(SUM(CB_6M_CHECKS) AS INT) CB_6M_CHECKS,
CAST(SUM(CB_6M_FIBER) AS INT) CB_6M_FIBER,
CAST(SUM(CB_3M_CHECKS) AS INT) CB_3M_CHECKS,
CAST(SUM(CB_3M_FIBER) AS INT) CB_3M_FIBER,
CAST(SUM(CB_NEWAREA_CHECKS) AS INT) CB_NEWAREA_CHECKS,
CAST(SUM(CB_NEWAREA_FIBER) AS INT) CB_NEWAREA_FIBER
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS" WHERE MSO = 'COMCAST' AND H1 = 'NORTHEAST DIVISION'
GROUP BY BUDGET_YEAR,BUDGET_MONTH,H1,REGION,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,SOW
) B
...
A.CB_NEWAREA_FIBER = B.CB_NEWAREA_FIBER
FROM
(SELECT BUDGET_YEAR,BUDGET_MONTH,H1,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,SOW,
CAST(SUM(IFF(PROJECT_TYPE= 'NQ',FIBER_COUNT,0)) AS INT) FIBER_COUNT_NQ, 
CAST(SUM(IFF(PROJECT_TYPE= 'WL',FIBER_COUNT,0)) AS INT) FIBER_COUNT_WL,
CAST(SUM(IFF(PROJECT_TYPE= 'BL',FIBER_COUNT,0)) AS INT) FIBER_COUNT_BL, 
CAST(SUM(FIBER_COUNT) AS INT) FIBER_COUNT, 
...
FROM (SELECT BUDGET_YEAR, BUDGET_MONTH, DIVISION, REGION, MSO, ENGAGEMENT_TYPE, PUBLISH_NAME, SOW, SUM(RECEIVED_COUNT) RECEIVED_COUNT, SUM(CASE WHEN PROJECT_TYPE='NQ' THEN RECEIVED_COUNT ELSE 0 END) AS RECEIVED_COUNT_NQ, SUM(CASE WHEN PROJECT_TYPE='WL' THEN RECEIVED_COUNT ELSE 0 END) AS RECEIVED_COUNT_WL FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" WHERE MSO = 'COMCAST' AND DIVISION = 'NORTHEAST DIVISION' GROUP BY ALL)B
WHERE A.MSO = B.MSO AND A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND UPPER(A.PUBLISHNAME) = UPPER(B.PUBLISH_NAME) AND A.H1 = B.DIVISION AND IFNULL(A.REGION,'') = IFNULL(B.REGION,'');

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" A
SET A.RECEIVED_COUNT_NQ  = B.RECEIVED_COUNT_NQ,
    A.RECEIVED_COUNT_WL  = B.RECEIVED_COUNT_WL,
    A.RECEIVED_COUNT   = B.RECEIVED_COUNT 
FROM (SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, PUBLISH_NAME, DIVISION, SOW, SUM(RECEIVED_COUNT) RECEIVED_COUNT, SUM(CASE WHEN PROJECT_TYPE='NQ' THEN RECEIVED_COUNT ELSE 0 END) AS RECEIVED_COUNT_NQ, SUM(CASE WHEN PROJECT_TYPE='WL' THEN RECEIVED_COUNT ELSE 0 END) AS RECEIVED_COUNT_WL FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" WHERE MSO = 'COMCAST' AND DIVISION <> 'NORTHEAST DIVISION' GROUP BY ALL)B
WHERE A.MSO = B.MSO AND A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND UPPER(A.PUBLISHNAME) = UPPER(B.PUBLISH_NAME) AND A.H1 = B.DIVISION;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" A
SET A.RECEIVED_COUNT_NQ  = B.RECEIVED_COUNT_NQ,
    A.RECEIVED_COUNT_WL  = B.RECEIVED_COUNT_WL,
    A.RECEIVED_COUNT   = B.RECEIVED_COUNT 
FROM (SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, PUBLISH_NAME, SOW, SUM(RECEIVED_COUNT) RECEIVED_COUNT, SUM(CASE WHEN PROJECT_TYPE='NQ' THEN RECEIVED_COUNT ELSE 0 END) AS RECEIVED_COUNT_NQ, SUM(CASE WHEN PROJECT_TYPE='WL' THEN RECEIVED_COUNT ELSE 0 END) AS RECEIVED_COUNT_WL FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_PLAN" WHERE MSO <> 'COMCAST' GROUP BY ALL)B
WHERE A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH AND A.MSO = B.MSO AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND UPPER(A.PUBLISHNAME) = UPPER(B.PUBLISH_NAME);

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" A
SET OPS_RECEIVED_COUNT_BL = OPS_TARGET - (IFF(RECEIVED_COUNT_NQ IS NULL ,0,RECEIVED_COUNT_NQ) + IFF(RECEIVED_COUNT_WL IS NULL ,0,RECEIVED_COUNT_WL));

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" 
SET OPS_RECEIVED_COUNT_BL = CASE WHEN CAST(OPS_RECEIVED_COUNT_BL AS INT)<0 THEN 0 ELSE OPS_RECEIVED_COUNT_BL END ;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" A
SET SOW_RECEIVED_COUNT_BL = SOW_TARGET - (IFF(RECEIVED_COUNT_NQ IS NULL ,0,RECEIVED_COUNT_NQ) + IFF(RECEIVED_COUNT_WL IS NULL ,0,RECEIVED_COUNT_WL));

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" 
SET SOW_RECEIVED_COUNT_BL = CASE WHEN CAST(SOW_RECEIVED_COUNT_BL AS INT)<0 THEN 0 ELSE SOW_RECEIVED_COUNT_BL END ;
...
DELIVERED = CASE WHEN  DELIVERED  IS NULL THEN 0 ELSE DELIVERED END,
FIBER_DELIVERED_NQ = CASE WHEN  FIBER_DELIVERED_NQ  IS NULL THEN 0 ELSE FIBER_DELIVERED_NQ END,
FIBER_DELIVERED_WL = CASE WHEN  FIBER_DELIVERED_WL  IS NULL THEN 0 ELSE FIBER_DELIVERED_WL END,
FIBER_DELIVERED_BL = CASE WHEN  FIBER_DELIVERED_BL  IS NULL THEN 0 ELSE FIBER_DELIVERED_BL END,
FIBER_DELIVERED = CASE WHEN  FIBER_DELIVERED  IS NULL THEN 0 ELSE FIBER_DELIVERED END,
...
OPS_RECEIVED_COUNT_BL = CASE WHEN  OPS_RECEIVED_COUNT_BL  IS NULL THEN 0 ELSE OPS_RECEIVED_COUNT_BL END,
SOW_RECEIVED_COUNT_BL = CASE WHEN  SOW_RECEIVED_COUNT_BL  IS NULL THEN 0 ELSE SOW_RECEIVED_COUNT_BL END,
RECEIVED_COUNT = CASE WHEN  RECEIVED_COUNT  IS NULL THEN 0 ELSE RECEIVED_COUNT END,
OPS_TARGET = CASE WHEN  OPS_TARGET  IS NULL THEN 0 ELSE OPS_TARGET END,
SOW_TARGET = CASE WHEN  SOW_TARGET  IS NULL THEN 0 ELSE SOW_TARGET END,
ZIP9_ALL_CHECKS =  CASE WHEN ZIP9_ALL_CHECKS  IS NULL THEN 0 ELSE ZIP9_ALL_CHECKS END,
ZIP9_ALL_FIBER = CASE WHEN ZIP9_ALL_FIBER   IS NULL THEN 0 ELSE ZIP9_ALL_FIBER END, 
ZIP9_12M_CHECKS = CASE WHEN ZIP9_12M_CHECKS  IS NULL THEN 0 ELSE ZIP9_12M_CHECKS END,
ZIP9_12M_FIBER = CASE WHEN ZIP9_12M_FIBER   IS NULL THEN 0 ELSE ZIP9_12M_FIBER END,
...
CAST(SUM(OPS_RECEIVED_COUNT_BL) AS INT) OPS_RECEIVED_COUNT_BL ,
CAST(SUM(SOW_RECEIVED_COUNT_BL) AS INT) SOW_RECEIVED_COUNT_BL ,
CAST(SUM(RECEIVED_COUNT) AS INT) RECEIVED_COUNT, 
CAST(SUM(OPS_TARGET) AS INT) OPS_TARGET_QUEUED,
CAST(SUM(SOW_TARGET) AS INT) SOW_TARGET_QUEUED
...
ADD COLUMN SOW_TARGET VARCHAR(16777216) DEFAULT NULL, OPS_TARGET VARCHAR(16777216) DEFAULT NULL;

UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS"   A
SET OPS_TARGET = B.MONTHLY_OPS_TARGET
FROM (SELECT MSO,ENGAGEMENT_TYPE,DIVISION,BUDGET_YEAR,CASE WHEN UPPER(PUBLISH_NAME)='ATT' THEN 'ATT'
                       WHEN UPPER(PUBLISH_NAME) IN ('TMOBILE5G-HOME','VERIZON1115G') THEN 'FWA'
                       ELSE 'NON ATT' END BUDGET_TYPE,CAST(SUM(MONTHLY_TARGET)/12 AS INT) AS MONTHLY_OPS_TARGET FROM
                       "SCIERA_SUBSYSTEM"."CTELL_TRACKING"."MSO_TRACKING" WHERE BUDGET_YEAR = 2025 GROUP BY 1,2,3,4,5) B
...
UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS"   A
SET SOW_TARGET = B.MONTHLY_SOW_TARGET
FROM (SELECT MSO,ENGAGEMENT_TYPE,DIVISION,BUDGET_YEAR,CASE WHEN UPPER(PUBLISH_NAME)='ATT' THEN 'ATT'
                       WHEN UPPER(PUBLISH_NAME) IN ('TMOBILE5G-HOME','VERIZON1115G') THEN 'FWA'
                       ELSE 'NON ATT' END BUDGET_TYPE,CAST(SUM(MONTHLY_SOW_TARGET)/12 AS INT) AS MONTHLY_SOW_TARGET FROM
                       "SCIERA_SUBSYSTEM"."CTELL_TRACKING"."MSO_TRACKING" WHERE BUDGET_YEAR = 2025 GROUP BY 1,2,3,4,5) B
WHERE UPPER(A.BUDGET_TYPE) =  UPPER(B.BUDGET_TYPE) AND A.BUDGET_YEAR = B.BUDGET_YEAR  AND REPLACE(A.MSO,'_BUSINESS','') = B.MSO
AND A.MSO <>'COMCAST'AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE ;
...
OPS_RECEIVED_COUNT_BL = CASE WHEN  OPS_RECEIVED_COUNT_BL  IS NULL THEN 0 ELSE OPS_RECEIVED_COUNT_BL END,
RECEIVED_COUNT = CASE WHEN  RECEIVED_COUNT  IS NULL THEN 0 ELSE RECEIVED_COUNT END,
OPS_TARGET_QUEUED = CASE WHEN  OPS_TARGET_QUEUED  IS NULL THEN 0 ELSE OPS_TARGET_QUEUED END,
SOW_TARGET_QUEUED = CASE WHEN  SOW_TARGET_QUEUED  IS NULL THEN 0 ELSE SOW_TARGET_QUEUED END,
OPS_TARGET = CASE WHEN  OPS_TARGET  IS NULL THEN 0 ELSE OPS_TARGET END,
SOW_TARGET = CASE WHEN  SOW_TARGET  IS NULL THEN 0 ELSE SOW_TARGET END;
...
SET SOW_TARGET = CASE WHEN PROJECT_TYPE = 'NQ' THEN RECEIVED_COUNT_NQ 
                  WHEN PROJECT_TYPE = 'BL' THEN SOW_RECEIVED_COUNT_BL 
                  WHEN PROJECT_TYPE = 'WL' THEN RECEIVED_COUNT_WL ELSE 0 END,
    OPS_TARGET = CASE WHEN PROJECT_TYPE = 'NQ' THEN RECEIVED_COUNT_NQ 
                  WHEN PROJECT_TYPE = 'BL' THEN OPS_RECEIVED_COUNT_BL 
                  WHEN PROJECT_TYPE = 'WL' THEN RECEIVED_COUNT_WL ELSE 0 END
...
(SELECT IFF(BUDGET_YEAR IS NULL,QUEUE_YEAR,BUDGET_YEAR) BUDGET_YEAR ,IFF(BUDGET_MONTH IS NULL,QUEUE_MONTH,BUDGET_MONTH) BUDGET_MONTH,REPLACE(REPLACE(REPLACE(RTRIM(SERVICENAME), '111', ' '),'222',','),'333','.') as SERVICENAME,PROJECTNAME,DMA,H1,ZIP5,ZIP4,REGION,
...
FROM "V4_CTELL"."PROC"."WIP_CURRENT" WHERE MSO = 'COMCAST'  GROUP BY 1,2,3,4,5,6,7,8,9);
...
SELECT BUDGET_YEAR,BUDGET_MONTH,SERVICENAME,PROJECTNAME,DMA,H1,ZIP5,REGION,SUM(BAU) BAU,SUM(NQ) NQ,SUM(WL) WL,
...
CROSS JOIN (SELECT DISTINCT SERVICENAME,PROJECTNAME,DMA,H1,ZIP5,REGION FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_COMCAST_HOME_PASSED_STAGING_2" ) DIST_NAME
) A
...
AND A.DMA = B.DMA AND A.H1 = B.H1 AND A.ZIP5 = B.ZIP5 AND A.REGION = B.REGION AND A.PROJECTNAME=B.PROJECTNAME;
...
INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS"
SELECT BUDGET_YEAR, BUDGET_MONTH, BUDGET_MONTH_ACTUAL, BUDGET_YEAR_ACTUAL, QUEUE_YEAR, QUEUE_MONTH, CHECKED_YEAR, CHECKED_MONTH, DELIVERED_YEAR, DELIVERED_MONTH, MSO, ENGAGEMENT_TYPE, BUDGET_TYPE, PROJECT_TYPE, DWELL_TYPE, PROJECT_NAME, PUBLISHNAME, STD_NAME, PROVIDER_TYPE, CLIENT_FILENAME, CLIENT_SENT_DATE, CLIENT_PROVIDER_NAME, H1, NULL AS REGION, ZIP5, DMA, FIBER_COUNT, FIBER_DELIVERED_COUNT, QUEUED, CHECKED, DELIVERED, UNDELIVERABLE, CHECKED_STATUS_AV, CHECKED_STATUS_NA, CHECKED_STATUS_ER, CHECKED_STATUS_NF, CHECKED_GIG_RESULT, DELIVERED_STATUS_AV, DELIVERED_STATUS_NA, DELIVERED_STATUS_ER, DELIVERED_STATUS_NF, DELIVERED_GIG_RESULT, ZIP9_ALL_CHECKS, ZIP9_ALL_FIBER, ZIP9_12M_CHECKS, ZIP9_12M_FIBER, ZIP9_6M_CHECKS, ZIP9_6M_FIBER, ZIP9_3M_CHECKS, ZIP9_3M_FIBER, ZIP9_NEWAREA_CHECKS, ZIP9_NEWAREA_FIBER, CB_ALL_CHECKS, CB_ALL_FIBER, CB_12M_CHECKS, CB_12M_FIBER, CB_6M_CHECKS, CB_6M_FIBER, CB_3M_CHECKS, CB_3M_FIBER, CB_NEWAREA_CHECKS, CB_NEWAREA_FIBER, SERVICENAME, DELIVERY_NAME, READY_FOR_DELIVERY, SOW, UPDATED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS_2024";

INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ZIP_ROLLUPS"
SELECT * FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ZIP_ROLLUPS_2024";

INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_DMA_ZIP_ROLLUPS"
SELECT * FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_DMA_ZIP_ROLLUPS_2024";

ALTER TABLE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS"
ADD COLUMN JAN_2024 NUMBER,
		   FEB_2024 NUMBER,
		   MARCH_2024 NUMBER,
		   APRIL_2024 NUMBER,
		   MAY_2024 NUMBER,
...
INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS" (BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, BUDGET_TYPE, PROJECT_TYPE, PROJECT_NAME, PUBLISHNAME, SERVICENAME, H1, REGION, SOW, DELIVERY_NAME, FIBER_COUNT, FIBER_DELIVERED_COUNT, QUEUED, CHECKED, DELIVERED, UNDELIVERABLE, READY_FOR_DELIVERY, CHECKED_STATUS_AV, CHECKED_STATUS_NA, CHECKED_STATUS_ER, CHECKED_STATUS_NF, CHECKED_GIG_RESULT, DELIVERED_STATUS_AV, DELIVERED_STATUS_NA, DELIVERED_STATUS_ER, DELIVERED_STATUS_NF, DELIVERED_GIG_RESULT, ZIP9_ALL_CHECKS, ZIP9_ALL_FIBER, ZIP9_12M_CHECKS, ZIP9_12M_FIBER, ZIP9_6M_CHECKS, ZIP9_6M_FIBER, ZIP9_3M_CHECKS, ZIP9_3M_FIBER, ZIP9_NEWAREA_CHECKS, ZIP9_NEWAREA_FIBER, CB_ALL_CHECKS, CB_ALL_FIBER, CB_12M_CHECKS, CB_12M_FIBER, CB_6M_CHECKS, CB_6M_FIBER, CB_3M_CHECKS, CB_3M_FIBER, CB_NEWAREA_CHECKS, CB_NEWAREA_FIBER, JAN_2024, FEB_2024, MARCH_2024, APRIL_2024, MAY_2024, JUNE_2024, JULY_2024, AUG_2024, SEP_2024, OCT_2024, NOV_2024, DEC_2024, CLIENT_SENT_DATE, CLIENT_FILE_NAME, CLIENT_PROVIDER_NAME, RECEIVED_COUNT, UPDATED_DATE)
SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, BUDGET_TYPE, PROJECT_TYPE, PROJECT_NAME, PUBLISHNAME, SERVICENAME, H1, NULL AS REGION, SOW, DELIVERY_NAME, FIBER_COUNT, FIBER_DELIVERED_COUNT, QUEUED, CHECKED, DELIVERED, UNDELIVERABLE, READY_FOR_DELIVERY, CHECKED_STATUS_AV, CHECKED_STATUS_NA, CHECKED_STATUS_ER, CHECKED_STATUS_NF, CHECKED_GIG_RESULT, DELIVERED_STATUS_AV, DELIVERED_STATUS_NA, DELIVERED_STATUS_ER, DELIVERED_STATUS_NF, DELIVERED_GIG_RESULT, ZIP9_ALL_CHECKS, ZIP9_ALL_FIBER, ZIP9_12M_CHECKS, ZIP9_12M_FIBER, ZIP9_6M_CHECKS, ZIP9_6M_FIBER, ZIP9_3M_CHECKS, ZIP9_3M_FIBER, ZIP9_NEWAREA_CHECKS, ZIP9_NEWAREA_FIBER, CB_ALL_CHECKS, CB_ALL_FIBER, CB_12M_CHECKS, CB_12M_FIBER, CB_6M_CHECKS, CB_6M_FIBER, CB_3M_CHECKS, CB_3M_FIBER, CB_NEWAREA_CHECKS, CB_NEWAREA_FIBER, JAN_2024, FEB_2024, MARCH_2024, APRIL_2024, MAY_2024, JUNE_2024, JULY_2024, AUG_2024, SEP_2024, OCT_2024, NOV_2024, DEC_2024, CLIENT_SENT_DATE, CLIENT_FILE_NAME, CLIENT_PROVIDER_NAME, RECEIVED_COUNT, UPDATED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS_2024";
		   
INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" (BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, H1, REGION, SOW, PUBLISHNAME, SOW_TARGET, BUDGET_TYPE, SERVICENAME, FIBER_COUNT_NQ, FIBER_COUNT_WL, FIBER_COUNT_BL, FIBER_COUNT, QUEUED_NQ, QUEUED_WL, QUEUED_BL, QUEUED, CHECKED_NQ, CHECKED_WL, CHECKED_BL, CHECKED, DELIVERED_NQ, DELIVERED_WL, DELIVERED_BL, DELIVERED, FIBER_DELIVERED_NQ, FIBER_DELIVERED_WL, FIBER_DELIVERED_BL, FIBER_DELIVERED, RECEIVED_COUNT_NQ, RECEIVED_COUNT_WL, SOW_RECEIVED_COUNT_BL, RECEIVED_COUNT, ZIP9_ALL_CHECKS, ZIP9_ALL_FIBER, ZIP9_12M_CHECKS, ZIP9_12M_FIBER, ZIP9_6M_CHECKS, ZIP9_6M_FIBER, ZIP9_3M_CHECKS, ZIP9_3M_FIBER, ZIP9_NEWAREA_CHECKS, ZIP9_NEWAREA_FIBER, CB_ALL_CHECKS, CB_ALL_FIBER, CB_12M_CHECKS, CB_12M_FIBER, CB_6M_CHECKS, CB_6M_FIBER, CB_3M_CHECKS, CB_3M_FIBER, CB_NEWAREA_CHECKS, CB_NEWAREA_FIBER, DELIVERY_NAME, UPDATED_DATE)
SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, H1, NULL AS REGION, SOW, PUBLISHNAME, TARGET AS SOW_TARGET, BUDGET_TYPE, SERVICENAME, FIBER_COUNT_NQ, FIBER_COUNT_WL, FIBER_COUNT_BL, FIBER_COUNT, QUEUED_NQ, QUEUED_WL, QUEUED_BL, QUEUED, CHECKED_NQ, CHECKED_WL, CHECKED_BL, CHECKED, DELIVERED_NQ, DELIVERED_WL, DELIVERED_BL, DELIVERED, FIBER_DELIVERED_NQ, FIBER_DELIVERED_WL, FIBER_DELIVERED_BL, FIBER_DELIVERED, RECEIVED_COUNT_NQ, RECEIVED_COUNT_WL, RECEIVED_COUNT_BL AS SOW_RECEIVED_COUNT_BL, RECEIVED_COUNT, ZIP9_ALL_CHECKS, ZIP9_ALL_FIBER, ZIP9_12M_CHECKS, ZIP9_12M_FIBER, ZIP9_6M_CHECKS, ZIP9_6M_FIBER, ZIP9_3M_CHECKS, ZIP9_3M_FIBER, ZIP9_NEWAREA_CHECKS, ZIP9_NEWAREA_FIBER, CB_ALL_CHECKS, CB_ALL_FIBER, CB_12M_CHECKS, CB_12M_FIBER, CB_6M_CHECKS, CB_6M_FIBER, CB_3M_CHECKS, CB_3M_FIBER, CB_NEWAREA_CHECKS, CB_NEWAREA_FIBER, DELIVERY_NAME, UPDATED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS_2024";

INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS" (BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, BUDGET_TYPE, H1, SOW, FIBER_COUNT_NQ, FIBER_COUNT_WL, FIBER_COUNT_BL, FIBER_COUNT, QUEUED_NQ, QUEUED_WL, QUEUED_BL, QUEUED, CHECKED_NQ, CHECKED_WL, CHECKED_BL, CHECKED, DELIVERED_NQ, DELIVERED_WL, DELIVERED_BL, DELIVERED, RECEIVED_COUNT_NQ, RECEIVED_COUNT_WL, SOW_RECEIVED_COUNT_BL, RECEIVED_COUNT, SOW_TARGET_QUEUED, SOW_TARGET, UPDATED_DATE)
SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, BUDGET_TYPE, H1, SOW, FIBER_COUNT_NQ, FIBER_COUNT_WL, FIBER_COUNT_BL, FIBER_COUNT, QUEUED_NQ, QUEUED_WL, QUEUED_BL, QUEUED, CHECKED_NQ, CHECKED_WL, CHECKED_BL, CHECKED, DELIVERED_NQ, DELIVERED_WL, DELIVERED_BL, DELIVERED, RECEIVED_COUNT_NQ, RECEIVED_COUNT_WL, RECEIVED_COUNT_BL AS SOW_RECEIVED_COUNT_BL, RECEIVED_COUNT, TARGET_QUEUED AS SOW_TARGET_QUEUED, TARGET AS SOW_TARGET, UPDATED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_BUDGET_TYPE_ROLLUPS_2024";

INSERT INTO "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROVIDER_ROLLUPS" (BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, PROJECT_TYPE, BUDGET_TYPE, SERVICENAME, PUBLISHNAME, SOW, DELIVERY_NAME, FIBER_COUNT, QUEUED, CHECKED, DELIVERED, FIBER_DELIVERED, RECEIVED_COUNT, UNDELIVERABLE, READY_FOR_DELIVERY, 
SOW_TARGET, UPDATED_DATE)
SELECT BUDGET_YEAR, BUDGET_MONTH, MSO, ENGAGEMENT_TYPE, PROJECT_TYPE, BUDGET_TYPE, SERVICENAME, PUBLISHNAME, SOW, DELIVERY_NAME, FIBER_COUNT, QUEUED, CHECKED, DELIVERED, FIBER_DELIVERED, RECEIVED_COUNT, UNDELIVERABLE, READY_FOR_DELIVERY, TARGET AS SOW_TARGET, UPDATED_DATE FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROVIDER_ROLLUPS_2024";
