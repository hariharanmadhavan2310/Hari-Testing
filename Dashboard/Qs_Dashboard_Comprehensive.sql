...
FROM
(SELECT BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,SOW,H1,
...
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS"
GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,SERVICENAME,PUBLISHNAME,SOW,H1
) B
WHERE A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
AND A.MSO = B.MSO AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND A.PUBLISHNAME =B.PUBLISHNAME AND A.BUDGET_YEAR = 2024;
...
WHERE A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
AND A.MSO = B.MSO AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND A.PUBLISHNAME =B.PUBLISHNAME AND A.H1 = B.H1 AND A.MSO = 'COMCAST' AND A.BUDGET_YEAR = 2025;
...
WHERE A.BUDGET_YEAR = B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH
AND A.MSO = B.MSO AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(B.SOW,'') AND A.PUBLISHNAME =B.PUBLISHNAME AND A.MSO <> 'COMCAST' AND A.BUDGET_YEAR = 2025;
