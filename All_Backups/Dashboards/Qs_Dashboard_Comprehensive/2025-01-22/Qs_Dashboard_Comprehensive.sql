...
UPPER(PROJECTNAME) AS PROJECT_NAME,UPPER(SERVICENAME) AS PUBLISHNAME,UPPER(STD_NAME) AS STD_NAME,RESULT_SOURCE,
...
,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,PROJECT_TYPE,DWELL_TYPE,PROJECT_NAME,SERVICENAME,STD_NAME,RESULT_SOURCE,PROVIDER_TYPE,CLIENT_FILENAME,CLIENT_SENT_DATE,CLIENT_PROVIDER_NAME,H1,ZIP5,DMA
...
SELECT BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,PROJECT_TYPE,PROJECT_NAME,PUBLISHNAME,SERVICENAME,H1,SOW,DELIVERY_NAME,RESULT_SOURCE,
...
SUM(IFF(DELIVERED_YEAR = 2024 AND DELIVERED_MONTH=11,DELIVERED,0)) AS NOV_2024,SUM(IFF(DELIVERED_YEAR = 2024 AND DELIVERED_MONTH=12,DELIVERED,0)) AS DEC_2024
 FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_ROLLUPS"
GROUP BY BUDGET_YEAR,BUDGET_MONTH,MSO,ENGAGEMENT_TYPE,BUDGET_TYPE,PROJECT_TYPE,PROJECT_NAME,PUBLISHNAME,SERVICENAME,H1,SOW,DELIVERY_NAME,RESULT_SOURCE;
...
FROM "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_ROLLUPS"  WHERE IFNULL(RESULT_SOURCE,'') <>'DP-PIPE'
...
INSERT INTO  "SCIERA_SUBSYSTEM"."QUICKSIGHT"."RPT_PROJECT_PROVIDER"
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_PROVIDER" A
...
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_CHECKS" A
...
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_COVERAGE_CB" A
...
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_COVERAGE_BIZ" A
...
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_COVERAGE_CB_TIER_ILEC" A
...
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_COVERAGE_BIZ_TIER_ILEC" A
...
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_COVERAGE_CB_TIER_TIER2" A
...
(SELECT A.* FROM "MSO"."V3_COMCAST_SMB"."RPT_PROJECT_COVERAGE_BIZ_TIER_TIER2" A
