...
SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=1,DELIVERED,0)) AS JAN_2025,SUM(IFF(DELIVERED_YEAR = 2025 AND DELIVERED_MONTH=2,DELIVERED,0)) AS FEB_2025,
...
UPDATE "SCIERA_SUBSYSTEM"."QUICKSIGHT"."QS_DASHBOARD_PROJECT_TYPE_ROLLUPS" A 
SET A.FIBER_EXTRAPOLATED_COUNT_BL = FIBER_EXTRAPOLATED_BL,
	A.FIBER_EXTRAPOLATED_COUNT_WL = FIBER_EXTRAPOLATED_WL,
	A.FIBER_EXTRAPOLATED_COUNT_NQ = FIBER_EXTRAPOLATED_NQ 
FROM (SELECT BUDGET_YEAR,BUDGET_MONTH, 'COX' AS MSO, 'RESI'  AS ENGAGEMENT_TYPE, NULL AS SOW, SERVICENAME,
...
FROM V4_CTELL.TEST.ZIP9_PROJECT_TYPE A, V4_CTELL.TEST.DELIVERY_ENUM_202501 B 
WHERE A.ZIP9 = SCIERA_ZIP5||SCIERA_ZIP4 AND A.CLIENT_DELIVERY_NAME=B.PROVIDER AND TRY_CAST(MAX_SPEED AS DOUBLE) >= 300 AND RN=1 AND BUDGET_YEAR= 2025 AND BUDGET_MONTH = 1 GROUP BY ALL) B
WHERE A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH 
...
SUM(IFF(PROJECT_TYPE='NQ',1,0)) AS FIBER_EXTRAPOLATED_NQ,
SUM(IFF(PROJECT_TYPE='WL',1,0)) AS FIBER_EXTRAPOLATED_WL 
FROM V4_CTELL.TEST.ZIP9_PROJECT_TYPE A, V4_CTELL.TEST.DELIVERY_ENUM_202502 B 
WHERE A.ZIP9 = SCIERA_ZIP5||SCIERA_ZIP4 AND A.CLIENT_DELIVERY_NAME=B.PROVIDER AND TRY_CAST(MAX_SPEED AS DOUBLE) >= 300 AND RN=1 AND BUDGET_YEAR = 2025 AND BUDGET_MONTH = 2 GROUP BY ALL) B
WHERE A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH 
AND A.MSO = B.MSO  AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(NULL,'')
AND UPPER(A.PUBLISHNAME) = UPPER(B.SERVICENAME);
...
SUM(IFF(PROJECT_TYPE='NQ',1,0)) AS FIBER_EXTRAPOLATED_NQ,
SUM(IFF(PROJECT_TYPE='WL',1,0)) AS FIBER_EXTRAPOLATED_WL 
FROM V4_CTELL.TEST.ZIP9_PROJECT_TYPE A, V4_CTELL.TEST.DELIVERY_ENUM_202503 B 
WHERE A.ZIP9 = SCIERA_ZIP5||SCIERA_ZIP4 AND A.CLIENT_DELIVERY_NAME=B.PROVIDER AND TRY_CAST(MAX_SPEED AS DOUBLE) >= 300 AND RN=1 AND BUDGET_YEAR = 2025 AND BUDGET_MONTH = 3 GROUP BY ALL) B
WHERE A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH 
AND A.MSO = B.MSO  AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(NULL,'')
AND UPPER(A.PUBLISHNAME) = UPPER(B.SERVICENAME);
...
SUM(IFF(PROJECT_TYPE='NQ',1,0)) AS FIBER_EXTRAPOLATED_NQ,
SUM(IFF(PROJECT_TYPE='WL',1,0)) AS FIBER_EXTRAPOLATED_WL 
FROM V4_CTELL.TEST.ZIP9_PROJECT_TYPE A, V4_CTELL.TEST.DELIVERY_ENUM B 
WHERE A.ZIP9 = SCIERA_ZIP5||SCIERA_ZIP4 AND A.CLIENT_DELIVERY_NAME=B.PROVIDER AND TRY_CAST(MAX_SPEED AS DOUBLE) >= 300 AND RN=1 AND BUDGET_YEAR= YEAR(CURRENT_DATE) AND BUDGET_MONTH=MONTH(CURRENT_DATE) GROUP BY ALL) B
WHERE A.BUDGET_YEAR =B.BUDGET_YEAR AND A.BUDGET_MONTH = B.BUDGET_MONTH 
AND A.MSO = B.MSO  AND A.ENGAGEMENT_TYPE = B.ENGAGEMENT_TYPE AND IFNULL(A.SOW,'') = IFNULL(NULL,'')
AND UPPER(A.PUBLISHNAME) = UPPER(B.SERVICENAME);
