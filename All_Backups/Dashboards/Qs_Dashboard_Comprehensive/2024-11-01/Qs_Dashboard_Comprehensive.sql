...
SET DELIVERY_NAME = CASE WHEN A.MSO = 'COX' THEN UPPER(B.COX_DELIVERY_NAME) 
                         ...
                         WHEN A.MSO = 'CHARTER' THEN UPPER(B.CHARTER_DELIVERY_NAME)
                         ELSE NULL END
...
SET BUDGET_TYPE = CASE WHEN UPPER(PUBLISHNAME)='ATT' THEN 'ATT'
                       WHEN UPPER(PUBLISHNAME) IN ('TMOBILE5G-HOME','TMOBILE5G-FIBER','VERIZON1115G') THEN 'FWA'
                       ELSE 'NON ATT' END,
...
CASE WHEN UPPER(PROVIDER)='ATT' THEN 'ATT'
                       WHEN UPPER(PROVIDER) IN ('TMOBILE5G-HOME','TMOBILE5G-FIBER','VERIZON1115G') THEN 'FWA'
